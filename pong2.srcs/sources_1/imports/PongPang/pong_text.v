...
module pong_text(
	...
	input[2:0] winner,
	input[3:0] score1_t,score2_t,score1_d,score2_d,
	input[9:0] ball,
...
//	 reg[4:0] score1_t,score1_d,score2_t,score2_d,ball_t,ball_d;
//	 reg[9:0] tmpscore1,tmpscore2,tmpball;
	 wire[7:0] row_data;
	 ...
	 always @* begin
		 ...
		 ascii_code_ball = 0;
			...
			case(pixel_x[7:4])
				...
				4'he: ascii_code_score1={3'b011,score1_t}; //:
				4'hf: ascii_code_score1={3'b011,score1_d}; //player 1 score
			endcase
			...
			case(pixel_x[9:4])
				...
				6'd37: ascii_code_score2={3'b011,score2_t}; //:
				6'd38: ascii_code_score2={3'b011,score2_d}; //player 2 score
...
//			if(ball_on) begin
//			 case(pixel_x[9:0]) 
//			     5'h04: ascii_code_ball={4'b0110,ball_t};//ball-left
//			     5'h05: ascii_code_ball={4'b0110,ball_d};//ball-left
//			 endcase
//			end
